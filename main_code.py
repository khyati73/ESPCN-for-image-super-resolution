...
Original file is located at
    https://colab.research.google.com/drive/1P0a29Seo4gF2mEjrU9VdwmgzKZWRH7wQ
"""
...
for index, test_img_path in enumerate(test_img_paths[50:60]):
    ...
    diff= abs(bicubic_psnr-test_psnr)
    print("Difference between PSNR values of lowres image and reconstructed image is %.4f" %diff)
...
diff2= abs(total_bicubic_psnr - total_test_psnr)
print("Difference between PSNR values of lowres image and reconstructed image is %.4f" %diff2)
